...
public enum DO {
    ...
    HUNT   (R.string.do_hunt, 2000 + 4, R.array.do_hunt, R.string.do_hunt_ru, R.string.do_hunt_activate, R.array.do_hunt_activate, R.drawable.placeholder),
    CREATE (R.string.do_create, 2000 + 5, R.array.do_create, R.string.do_create_ru, R.string.do_create_activate, R.array.do_create_activate, R.drawable.placeholder),
